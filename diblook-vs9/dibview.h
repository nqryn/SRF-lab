...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnProcessingRansacline();
	afx_msg void OnProcessingRansaccerc();
	afx_msg void OnProcessingHoughlinie();
	afx_msg void OnHoughlinieStep1();
	afx_msg void OnHoughlinieStep2();
	afx_msg void OnHoughlinieStep3();
};
